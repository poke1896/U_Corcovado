...
export default function WhatsAppButton({ label = 'Reservar por WhatsApp' }: Props) {
  const phone = '50670000000'; // Remplazar por número real
  const message = encodeURIComponent('Hola Ulises, me interesa reservar un tour en Corcovado.');
  const href = `https://wa.me/${phone}?text=${message}`;
  return (
    <a href={href} target="_blank" rel="noopener" className="btn-primary hover:text-[#B6FF00]">
